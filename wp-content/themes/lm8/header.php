...
<head>
    ...
    <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/jquery.min.js"></script><!--Digunakan jika offline dan dihapus jika sudah online-->
            ...
            $('.submit-pesan').click(function() { 
                ...
                jQuery.ajax(
                {
                    ...
                    data:
                    {
                           action: 'text',
                ada_pesan2 : '1',
                Emailto:'<?php global $save_default_email; echo $save_default_email; ?>',
